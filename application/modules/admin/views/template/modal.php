    ...
    <div id="geo-location" class="modal fade" tabindex="-1" data-width="450">
        ...
        <div class="modal-body">
            ...
            if (isset($geolocation['form'])):
                ...
                ?>
                <p id="geo-message"></p>
                <div class="form-group">Latitude: <input type="text" value=" " class="geolocation_latitude form-control" name="latitude"></div>
                <div class="form-group">Longitude: <input type="text" value=" " class="geolocation_longitude form-control" name="longitude"></div>
                <input type="hidden" name ="order_id" value="<?php echo $geolocation['form']['value']['order_id']; ?>">
                <input type="hidden" name ="address_book_id" value="<?php echo $geolocation['form']['value']['address_book_id']; ?>">
