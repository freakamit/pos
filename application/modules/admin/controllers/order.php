...
class Order extends CI_Controller
{
    ...
    public function _generate_pdf($html, $title, $paper = 'A4', $filename)
    {
        ...
        $boot_style = $this->url_get_contents(base_url('assets/css/bootstrap/bootstrap.min.css')); //css ko link dine
        $cust_style = $this->url_get_contents(base_url('assets/css/pdf_style.css')); //css ko link dine
